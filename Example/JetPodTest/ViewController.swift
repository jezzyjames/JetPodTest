...
//  JetPodTest
//
//  Created by jezzyjames on 02/23/2022.
//  Copyright (c) 2022 jezzyjames. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    let blinkingLabel = JetPodTest(frame: CGRect(x: 10, y: 20, width: 200, height: 30))
